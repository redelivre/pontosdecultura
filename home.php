	...
	<section id="search-result" class="search-result search-area clearfix">
		<div class="container">
			...
			<div class="search-not-here">
				...
				<?php printf( __( 'Não encontrou o procurava? Participe <a href="%s">cadastre sua pesquisa</a> ou <a href="%s">entre em contato</a> conosco!', 'pontosdecultura' ),  EmRede::get_new_url(), get_bloginfo( 'url' ) . '/contato' ); ?>
			</div>
		</div>
	</section>
<?php get_footer(); ?>
